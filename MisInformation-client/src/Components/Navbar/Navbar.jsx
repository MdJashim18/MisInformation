...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-100 shadow-sm w-[100%] mx-auto">
            ...
            <div className="navbar-end pr-5">
                <div className="w-10 h-10 rounded-full ring-2 ring-[#632EE3] ring-offset-2 bg-gradient-to-r from-[#632EE3] to-[#9F62F2] flex items-center justify-center">
